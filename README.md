...
- **Viết tắt**: khi chuỗi chữ bạn gõ không thể là một âm tiết bình thường (ví dụ `nhma`, `nch`), bàn phím tự chia thành các tiền tố âm tiết và gợi ý từ ghép khớp từng đoạn.
